...
# QUESTION, IS SD_INIT THE SD(Y) OR SD(DF$AGE50_BIOMASS)?
...
df.CI %>% #filter(age50>=60) %>% 
  ...
  labs(x = "Age (years)", y = "Aboveground Biomass (gC/m2)") +
  theme_bw()
#QUESTION: DO YOU WANT THE GRAPH ONLY 60-70? AND THEREFORE ONLY SHOWING THE SECOND ASSIMILATED DATA POINT? 
```
